...
<body>
    <div class="container">
        ...
        <div style="text-align:center;margin-bottom:20px;">
            <a href="https://noah-financial.onrender.com/login" style="background:linear-gradient(45deg,#FFD700,#FF8C00);color:#000;padding:15px 30px;border-radius:30px;text-decoration:none;font-weight:bold;display:inline-block;">💼 الدخول إلى النظام المالي</a>
        </div>
        <form method="POST">
        ...
        {% endif %}
        <a href="https://noah-financial-1.onrender.com">💼 النظام المالي</a> | <a href="https://noah-financial-4.onrender.com/medical_login">🏥 النظام الطبي</a> | <a href="/">🏠 الرئيسية</a> |
